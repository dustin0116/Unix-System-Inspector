...
/**
 * The structure for load average.
 **/
struct load_avg {
    double one;
    double five;
...
/**
 * The structure for CPU statistics.
 **/
struct cpu_stats {
    long idle;
    long total;
...
/**
 * The structure for memory statistics.
 **/
struct mem_stats {
    double used;
    double total;
...
/**
 * The structure for overall task statistics.
 **/
struct task_stats {
    unsigned int total;
...
/**
 * The structure for each individual task.
 **/
struct task_info {
    pid_t pid;
    uid_t uid;
...
int pfs_hostname(char *proc_gir, char *hostname_buf, size_t buf_sz);
